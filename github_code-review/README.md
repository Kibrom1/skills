...
2. Navigate to the `github_code-review/` folder
3. Click **Releases** on the right sidebar → download `github_code-review.plugin`
...
```
The `.plugin` file is in the root of the `github_code-review/` folder.

### Step 2 — Install into Claude Desktop

- **macOS / Windows**: Double-click `github_code-review.plugin`
